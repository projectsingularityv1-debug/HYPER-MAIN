...
-- Tabs Setup
local OffenseTab  = Window:Tab({ Title = "Offense",  Icon = "zap" })
local DefenseTab  = Window:Tab({ Title = "Defense",  Icon = "shield" })
local MovementTab = Window:Tab({ Title = "Movement", Icon = "navigation" })
local InfoTab     = Window:Tab({ Title = "Info",     Icon = "info" })

-- Offense Tab
OffenseTab:Section({ Title = "Ball Automation", Icon = "zap" })
...
-- Defense Tab
DefenseTab:Section({ Title = "Auto Defense", Icon = "shield" })
...
-- Movement Tab
MovementTab:Section({ Title = "Movement & Speed", Icon = "navigation" })
