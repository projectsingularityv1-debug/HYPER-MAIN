...
-- // Zombie Apocalypse Edition (Powered by Dummy Kawaii UI)
...
pcall(function()
    for _, v in ipairs(CoreGui:GetChildren()) do
        if v.Name == "Dummy Kawaii" or v.Name == "SingularityAimbotHub" or v.Name == "ZombieApocalypseHub" then v:Destroy() end
    end
...
-- ============================================
-- // 11. STANDALONE SINGULARITY UI LIBRARY (NATIVE)
-- ============================================
...
UserTab:Label({ Title = "📦 Version:", Desc = "v8.5 (Powered by Dummy Kawaii UI)" })
...
print("✅ Singularity Aimbot & ESP Hub Loaded Successfully!")
