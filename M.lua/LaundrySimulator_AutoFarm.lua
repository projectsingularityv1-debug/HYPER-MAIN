...
local _rawUI = game:HttpGet("https://projectsingularity.online/raw/repos/191c9695-c9f9-4b5f-805f-d87e8e3b8fac/ui.lua")
...
if getgenv().LaundryFarmRunning then
    ...
    task.wait(1) -- Wait for old loop to stop
end
...
PlayerTab:Slider({
    Title = "Fly Speed",
    Desc = "Adjust fly speed (Default 60)",
    Min = 10,
    Max = 300,
    Default = 60,
    Callback = function(val)
...
FilterTab:Toggle({ Title = "Normal", Image = "target", Value = getgenv().FilterNormal, Callback = function(v) getgenv().FilterNormal = v end })
FilterTab:Toggle({ Title = "Gold / Yellow", Image = "target", Value = getgenv().FilterGold, Callback = function(v) getgenv().FilterGold = v end })
FilterTab:Toggle({ Title = "Purple / Pink", Image = "target", Value = getgenv().FilterPurple, Callback = function(v) getgenv().FilterPurple = v end })
FilterTab:Toggle({ Title = "Red", Image = "target", Value = getgenv().FilterRed, Callback = function(v) getgenv().FilterRed = v end })
FilterTab:Toggle({ Title = "Blue", Image = "target", Value = getgenv().FilterBlue, Callback = function(v) getgenv().FilterBlue = v end })
FilterTab:Toggle({ Title = "Green", Image = "target", Value = getgenv().FilterGreen, Callback = function(v) getgenv().FilterGreen = v end })
FilterTab:Toggle({ Title = "Other Effects", Image = "target", Value = getgenv().FilterOther, Callback = function(v) getgenv().FilterOther = v end })

-- Cloth Type Filters
FilterTab:Toggle({ Title = "Mitten", Image = "target", Value = getgenv().FilterMitten, Callback = function(v) getgenv().FilterMitten = v end })
FilterTab:Toggle({ Title = "Sock", Image = "target", Value = getgenv().FilterSock, Callback = function(v) getgenv().FilterSock = v end })
FilterTab:Toggle({ Title = "Shirt", Image = "target", Value = getgenv().FilterShirt, Callback = function(v) getgenv().FilterShirt = v end })
FilterTab:Toggle({ Title = "Shorts", Image = "target", Value = getgenv().FilterShorts, Callback = function(v) getgenv().FilterShorts = v end })
FilterTab:Toggle({ Title = "Sweater", Image = "target", Value = getgenv().FilterSweater, Callback = function(v) getgenv().FilterSweater = v end })
FilterTab:Toggle({ Title = "Towel", Image = "target", Value = getgenv().FilterTowel, Callback = function(v) getgenv().FilterTowel = v end })
FilterTab:Toggle({ Title = "Underpants", Image = "target", Value = getgenv().FilterUnderpants, Callback = function(v) getgenv().FilterUnderpants = v end })
